...
#Project overview
###Our main goal in this project was to use a dataset with financial information about different hospitals to find where prices were different. We also wanted to find the best hospitals for care depending on both insurance provider and medical condition. 
...
###This dataset includes hospital names, 6 common medical conditions in the US, and 5 common insurance providers. It also included the names of each patient admitted, which we have changed into numerical IDs for privacy purposes.
